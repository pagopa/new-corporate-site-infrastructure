...
resource "aws_cloudfront_response_headers_policy" "websites" {
  ...
  security_headers_config {
    content_security_policy {
      content_security_policy = "script-src 'self' 'unsafe-inline' www.youtube.com https://*.cookielaw.org https://*.onetrust.com https://www.google-analytics.com https://cdn.matomo.cloud/pagopa.matomo.cloud https://pagopa.matomo.cloud https://recaptcha.net https://www.gstatic.com https://www.google.com https://www.googletagmanager.com https://*.sapsf.eu; style-src 'self' 'unsafe-inline' recaptcha.net; object-src 'none'; form-action 'self' https://*.sapsf.eu; font-src data: 'self'; connect-src 'self' https://pagopa.matomo.cloud https://*.cookielaw.org https://*.onetrust.com https://www.google-analytics.com https://api.io.italia.it *.google-analytics.com https://*.sapsf.eu; img-src data: 'self' *.cloudfront.net recaptcha.net https://*.sapsf.eu; frame-src https://www.google.com https://recaptcha.net https://www.youtube.com https://pagopa.applytojob.com https://career55.sapsf.eu"
      override                = true
    }
  }
}
